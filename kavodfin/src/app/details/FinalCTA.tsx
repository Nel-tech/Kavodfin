...
function FinalCTA() {
    ...
    return (
        <motion.div {...fadeUp} viewport={{ once: true }}>
            <div className="text-center mt-[8rem] bg-black p-12 shadow-2xl">
                ...
                <p className="text-white/90 mb-8 max-w-2xl mx-auto text-lg leading-relaxed font-inter">
                    ...
                    <span className="block mt-2 font-semibold font-inter">
                ...
                <p className="text-white text-sm mt-6 font-medium font-inter">
                    Only for serious traders ready to take action
                </p>
            </div>
        </motion.div>
    );
